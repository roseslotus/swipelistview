...
/**
 * XListView, it's based on <a href="https://github.com/Maxwin-z/XListView-Android"></a>
 */
...
//    private static final String TAG = "XListView";
    ...
    private void startLoadMore() {
        mPullLoading = true;
        if (mFooterView != null && mFooterView.getState() != XFooterView.STATE_LOADING) {
